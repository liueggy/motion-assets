...
A dark particle vortex animation showing swirling galaxy-like energy motion.
...
<picture>
  ...
  <img class="motion-asset" src="./motion.gif" alt="Particle Vortex" width="96" height="96" />
</picture>
```
